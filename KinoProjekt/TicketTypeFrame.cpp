    ...
    : wxFrame(nullptr, wxID_ANY, title), movie(movie), date(date), time(time), type(type), language(language)
{
    ...
    label2 = new wxStaticText(panel1, wxID_ANY, L"Ilość", wxPoint(630, 100), wxDefaultSize, wxALIGN_CENTER);
    ...
    staticText6 = new wxStaticText(panel1, wxID_ANY, L"21 zł", wxPoint(890, 150), wxDefaultSize, wxALIGN_CENTER);
    ...
    staticText7 = new wxStaticText(panel1, wxID_ANY, L"16 zł", wxPoint(890, 200), wxDefaultSize, wxALIGN_CENTER);
    ...
    button0 = new wxButton(panel1, wxID_ANY, L"WYBÓR MIEJSC", wxPoint(560,250), wxSize(200, 60));
    ...
    spinText = new wxStaticText(panel1, wxID_ANY, L"Do zapłaty: ", wxPoint(590, 320), wxDefaultSize, wxALIGN_CENTER);
