...
ContactFrame::ContactFrame(const wxString& title) : wxDialog(nullptr, wxID_ANY, title)
{
	...
	staticText4 = new wxStaticText(panel1, wxID_ANY, L"Eryk Dziewoński", wxPoint(280, 105), wxDefaultSize);
	...
	staticText6 = new wxStaticText(panel1, wxID_ANY, L"Michał Radziukiewicz", wxPoint(280, 140), wxDefaultSize);
