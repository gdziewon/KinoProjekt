#include "PaymentProcessor.h"
    ...
    bool PaymentProcessor::processPayment(const std::string& cardNumber, const std::string& cardHolder, const std::string& expiryDate, const std::string& cvv, double amount) {
    ...
    bool PaymentProcessor::connectToPaymentGateway() {
    ...
    bool PaymentProcessor::authorizePayment(const std::string& cardNumber, const std::string& cardHolder, const std::string& expiryDate, const std::string& cvv) {
    ...
    bool PaymentProcessor::processPaymentAmount(double amount) {
    ...
    void PaymentProcessor::disconnectFromPaymentGateway() {
